...
they do not include custom rules for the campaign frame— those come later in their own section 
Distinctions also mark where the GMfacing information truly begins While GMs can share some information from this section with their players this is where you start layering in the secrets they’ll use to build compelling story arcs across 
their campaign
 BUILDING DISTINCTIONS 
Distinctions may be one of the first things you develop when creating the campaign frame since they serve as the pillars or core truths of that setting Consider the following ideas when writing out your campaign frame’s distinctions: How the World Works: Convey the way magic functions in this setting (such as taking the form of technology in Motherboard) a prominent threat like a disease (such as the Serpent’s Sickness in The Witherwild) or other major setting elements that will inform play (such as the Lure in Beast Feast)
...
build on the provided materials with their own ideas The writeup doesn’t need to be encyclopedic especially if you’re sticking to the capsule format of the campaign frames from the core rulebook which are designed to be inspirational 
